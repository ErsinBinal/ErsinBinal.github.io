...
| Üye sosyal sohbet omurgası | Repo/frontend tamam; girişli backend kabulü bekliyor | RLS/RPC korumalı arkadaşlık, kalıcı özel/grup mesajı ve sunucu engeli; anon `PGRST202` yetki tasarımı nedeniyle kurulum kanıtı değildir |
| Sosyal sohbet UX + sembol rafı | Frontend canlı ve kabul edildi; girişli backend kabulü bekliyor | Açık `ÖZEL MESAJ`, konuşma içi engel ve onay; ortak/özel kutuda 24 ASCII SMS dönemi ifadesi; 82 unit + 12 Worker + 9 yerel Chromium, 2 canlı chat ve 11 smoke geçti |
