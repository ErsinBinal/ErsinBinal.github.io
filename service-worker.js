...
const CACHE_NAME = 'convivium-v163';
...
const PRECACHE_ASSETS = [
  ...
  '/assets/js/bugy-pet.js?v=11',
  '/assets/js/deb-companion.js?v=4',
  '/assets/js/home/routes.js?v=4',
  '/assets/js/sfx.js?v=15',
  '/assets/js/home-protocol.js?v=55',
